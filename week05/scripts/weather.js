...
const url = "https://api.openweathermap.org/data/2.5/weather?lat=49.754&lon=6.639&appid=ddd043892151b2655ed37384bd9fd0e3&units=imperial";
...
function displayResults(data) {
    currentTemp.innerHTML = `${data.main.temp}&deg;F`; // Display temperature in Fahrenheit
